...
def search(topic_id, index, k, custom, vector, q):
    ...
    if not vector:
        ...
        for i in ordered_doc:
            if es.get(index=index, id=i[0])['_source']['annotation'].split('-')[0] == topic_id:
...
if __name__ == "__main__":
    ...
    # query1 = parse_wapo_topics("pa5_data/topics2018.xml")["336"][query_type_index[args.query_type]]
    # searched_result1 = search('336', args.index_name, args.top_k, args.usermode, args.vector_name, query1)
    #
    # query2 = parse_wapo_topics("pa5_data/topics2018.xml")["341"][query_type_index[args.query_type]]
    # searched_result2 = search('341', args.index_name, args.top_k, args.usermode, args.vector_name, query2)
    #
    # query3 = parse_wapo_topics("pa5_data/topics2018.xml")["347"][query_type_index[args.query_type]]
    # searched_result3 = search('347', args.index_name, args.top_k, args.usermode, args.vector_name, query3)
    #
    # query4 = parse_wapo_topics("pa5_data/topics2018.xml")["350"][query_type_index[args.query_type]]
